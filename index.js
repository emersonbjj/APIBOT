...
app.use(function (req, res, next) { res.header("Access-Control-Allow-Origin", 'Cache-Control', 'private, no-cache, no-store, must-revalidate', "*"); res.header("Access-Control-Allow-Headers", 'Cache-Control', 'private, no-cache, no-store, must-revalidate',"Origin, X-Requested-With, Content-Type, Accept"); res.header('Access-Control-Allow-Methods', 'POST, GET'); next(); });
